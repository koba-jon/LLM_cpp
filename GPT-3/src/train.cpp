...
// Function Prototype
void valid(po::variables_map &vm, DataLoader::TextFolder &valid_dataloader, torch::Device &device, Loss &criterion, GPT3 &model, const size_t epoch, visualizer::graph &writer);
