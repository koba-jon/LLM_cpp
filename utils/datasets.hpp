...
namespace datasets{
    ...
    torch::Tensor Text_Loader(const std::string &path, const std::shared_ptr<tokenizers::Tokenizer> &tokenizer, const long int &sequence, const int &endoftext, const int &padding);
